...
<!-- AUTO:TEST_COUNT -->461<!-- /AUTO:TEST_COUNT --> tests across <!-- AUTO:TEST_FILES -->35<!-- /AUTO:TEST_FILES --> files (unit + integration), plus 7 e2e cases in real Chrome.
...
<!-- AUTO:COV_LINES -->98.1<!-- /AUTO:COV_LINES --> lines /
<!-- AUTO:COV_BRANCHES -->91.4<!-- /AUTO:COV_BRANCHES --> branches /
<!-- AUTO:COV_FUNCS -->97.5<!-- /AUTO:COV_FUNCS --> functions.
