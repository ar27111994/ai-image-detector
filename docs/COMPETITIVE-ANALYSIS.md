...
| Ensemble                  | Single neural model only                                                                | Neural + forensic metadata (C2PA/EXIF/XMP/PNG), fused (a 2D-FFT spectral module exists but is dormant — not in the shipped fusion) |
